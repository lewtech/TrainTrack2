//
//  DestinationsViewControllerTest.swift
//  TrainTrack
//
...
class DestinationsViewControllerTest: UIViewController , UITableViewDataSource, UITableViewDelegate{
...
// MARK: TABLEVIEW
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = destinationTableView.dequeueReusableCell(withIdentifier: cellID, for: indexPath)
